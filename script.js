document.addEventListener('DOMContentLoaded', function () {
  ...
  const elements = document.querySelectorAll(
    '.fade-in, .animate-on-scroll, [data-animate], .section-title, .feature-card, .pricing-card, .testimonial-card, .team-card, .service-card, .blog-card, .hero-content, .about-content, .cta-content'
  );
    ...
    if ('IntersectionObserver' in window) {
      ...
      elements.forEach(function (el, index) {
        if (!el.hasAttribute('data-delay')) {
          ...
          el.setAttribute('data-delay', siblingIndex * 80);
        }
        observer.observe(el);
      });
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Adam Rize uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'c2ef182f-701a-4fb3-9495-a2ee2727378f',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'c2ef182f-701a-4fb3-9495-a2ee2727378f';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'c2ef182f-701a-4fb3-9495-a2ee2727378f';
